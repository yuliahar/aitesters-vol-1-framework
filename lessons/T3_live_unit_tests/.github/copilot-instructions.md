...
⚠️ **Never directly read `.env` files** in code or tests. Always reference credentials through AI using `#file:.env.ai` placeholders to ensure sensitive data is handled securely.
